...
PREPROCESSED_DIR = Path(
    ...
    "2026_cAMP_wholebrain_with_pdfr1_BlaC_Immobilized/InitialBleached/pre-processed"
)
OUTPUT_DIR = Path("/home/lauren/quick_wholebrain_overview/outputs")
FRAME_RATE_HZ = 1.7

# Condition mapping
# SWF1578 = BlaC-Catalytically Dead controls
# SWF1555 = BlaC experimental
BLAC_CAT_DEAD = [
    "20260409_SWF1578_1",
    "20260409_SWF1578_2",
    "20260409_SWF1578_3",
...
if __name__ == "__main__":
    ...
    all_conditions = (["BlaC-Cat.Dead"] * len(blac_cat_dead) +
                      ["BlaC"] * len(blac))
    n_frames = open_zarr(all_names[0]).shape[0]
    ...
    # Use middle frames to avoid edge artifacts (skip 50 from each end)
    window = slice(50, n_frames - 50)
